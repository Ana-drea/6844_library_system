...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="tbl">
        <tr>
            <td class="tblhead">BOOK RETURN FORM</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
                                    ...
                                    <table class="style4">
                                        ...
                                        <tr>
                                            ...
                                            <td class="style8" valign="top">
                                                <table class="style7">
                                                    <tr>
                                                        <td class="style15" style="font-size: medium">Autor :</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style15" style="font-size: medium">Branch :
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style15" style="font-size: medium">&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="style15" style="font-size: medium">Panalty Status :&nbsp;
                                                        </td>
                                                        <td>
