                                    ...
                                    <table class="style4">
                                        ...
                                        <tr>
                                            ...
                                            <td class="style8" valign="top">
                                                <table class="style7">
                                                    <tr>
                                                        <td class="style14" style="font-size: medium">Autor :</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style14" style="font-size: medium">&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="style14" style="font-size: medium">Total Quantity :
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style14" style="font-size: medium">Availabale Qnt :
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style14" style="font-size: medium">Rent Qnt :
                                                        </td>
                                                        <td>
